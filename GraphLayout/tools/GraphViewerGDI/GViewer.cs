...
namespace Microsoft.Msagl.GraphViewerGdi
{
	...
	public sealed partial class GViewer : UserControl
	{
		...
		const string PanButtonDisabledToolTipText = "جابجایی با دست, هم اکنون غیر فعال";
		ToolBarButton print;
		...
		bool wasMinimized;
		const string WindowZoomButtonToolTipText = "زوم کردن با کشیدن یک مستطیل بوسیله ماوس";
		...
		void InitializeComponent()
		{
			...
			this.zoomin.ToolTipText = "بزرگنمایی";
			// 
			// zoomout
			// 
			this.zoomout.ImageIndex = 1;
			this.zoomout.Name = "zoomout";
			this.zoomout.ToolTipText = "کوچکنمایی";
			// 
			// windowZoomButton
			// 
			...
			this.windowZoomButton.ToolTipText = "زوم به محدوده مستطیل";
			// 
			// panButton
			// 
			...
			this.panButton.ToolTipText = "دست";
			// 
			// backwardButton
			// 
			this.backwardButton.ImageIndex = 6;
			this.backwardButton.Name = "backwardButton";
			this.backwardButton.ToolTipText = "به عقب";
			// 
			// forwardButton
			// 
			...
			this.saveButton.ToolTipText = "ذخیره گراف";
			// 
			// undoButton
			// 
			...
			this.openButton.ToolTipText = "باز کردن فایل ";
			// 
			// print
			// 
			this.print.ImageIndex = 11;
			this.print.Name = "print";
			this.print.ToolTipText = "چاپ نمای فعلی";
			// 
			...
			this.edgeInsertButton.ToolTipText = "درج لبه";
			// 
			// GViewer
			// 
		...
		MenuItem[] CreateSaveMenuItems()
		{
			...
			{
				menuItems.Add(menuItem = new MenuItem("ذخیره گراف به فرمت خام"));
				menuItem.Click += SaveGraphClick;
			}
			if (SaveAsImageEnabled)
			{
				menuItems.Add(menuItem = new MenuItem("ذخیره به فرمت عکس"));
				menuItem.Click += SaveImageClick;
			}
			if (SaveInVectorFormatEnabled)
			{
				menuItems.Add(menuItem = new MenuItem("ذخیره به فرمت وکتور"));
